...
<body>
    ...
    <div class="surfSection1">
        ...
        <div class="content textsec ">
            ...
            <p>It’s the centre of surf culture on the south coast of
                Sri Lanka. Surrounded by some of the most amazing surf spots in the world, come have fun with us in the
                surf – from catching your first wave to learning all aspects of the surfing lifestyle, we’ve got you
                covered with lessons for all levels, guided surf sessions and board rentals.</p>
