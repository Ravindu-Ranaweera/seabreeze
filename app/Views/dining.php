...
<body>
    ...
    <div class="boxes">
        ...
        <div class="details">
            ...
            <div class="box">
                <p class="text">
                    Our delicious restaurant specializes in freshly brewed coffee, specialty drinks, mouthwatering
                    pastries, light snacks, and decadent desserts.
                    Appreciate our sophisticated Bar' upbeat ambiance with light restaurant bites, fine wines and
                    cocktails.
                </p>
            </div>
        </div>
    ...
    <div class="dineset">
        ...
        <figure class="dineset-block">
            ...
            <div class="foodImage"><img src="<?php echo BURL.'assets/img/dining/food1.jpeg'; ?>" alt="pr-sample15" />
            </div>
            <figcaption>
                <h3>Breakfast</h3>
                <p>The most important meal of the day is provided with both traditional and western options and a fine
                    china pot of Sri Lankan tea to go with.</p>
        ...
        <figure class="dineset-block center ">
            ...
            <figcaption>
                <h3>Lunch</h3>
                <p>Large amount of delicious, gently spiced dishes in the traditional menu and, mouthwatering seafood
                    and, tasty pasta and spaghetti awaits you at lunch.</p>
            </figcaption><span class="read-more">
        ...
        <figure class="dineset-block">
            ...
            <div class="foodImage"><img src="<?php echo BURL.'assets/img/dining/food3.jpg'; ?>" alt="pr-sample16" />
            </div>
            <figcaption>
                <h3>Dinner</h3>
                <p>You can choose from a simple traditional menu or the flavorful soups or delectable spicy kottu to end
                    the day with a full stomach.</p>
            </figcaption><span class="read-more">
        ...
        <div class="menu">
            <div class="single-menu">
                ...
                <div class="menu-content">
                    <h4>Chicken Fried Salad <span>LKR 650</span></h4>
                    <p class="text">Fried chicken salad is the perfect fuse of crispy chicken and fresh vegetables in a
                        dressing.</p>
                </div>
            </div>
            ...
            <div class="single-menu">
                ...
                <div class="menu-content">
                    <h4>Prawn tawa roast <span>LKR 4500</span></h4>
                    <p class="text">Prawn tawa roast is a quick dish you could ever make with prawns</p>
                </div>
            </div>
            ...
            <div class="single-menu">
                ...
                <div class="menu-content">
                    <h4>Prawn Fried Salad <span>LKR 750</span></h4>
                    <p class="text"> Experiment with Southern-style coating on prawns, instead of chicken.
                        facilis</p>
                </div>
            </div>
            ...
            <div class="single-menu">
                ...
                <div class="menu-content">
                    <h4>Sri Lankan Crab Curry <span>LKR 2300</span></h4>
                    <p class="text">If you are a seafood lover and love eating spicy dishes, then you should definitely
                        try Sri Lankan Crab Curry. </p>
                </div>
            </div>
            <div class="single-menu">
                <img src="<?php echo BURL.'assets/img/dining/e.jpg'; ?>">
                <div class="menu-content">
                    <h4>Chicken Fried Salad <span>LKR 750</span></h4>
                    <p class="text">A Crispy Fried Fish in Ginger Garlic Sauce</p>
                </div>
            </div>
            <div class="single-menu">
                ...
                <div class="menu-content">
                    <h4>
                        Since independence
                        Crispy Fried Chicken <span>LKR 3200</span></h4>
                    <p class="text">Using the recently leaked secret spice blend from KFC and best frying practices</p>
                </div>
            </div>
    ...
    <div class="dineset">
        ...
        <figure class="drinks a">
            ...
            <figcaption>
                <p>Bring the litre of water to a boil, remove from heat and add tea leaves. Keep for 3-5 minutes.Adding
                    ginger, lemon and honey will also help to soothe a sore throat.</p>
                <div class="price">
                    <s>LKR 1000.00</s>LKR 950.00
                </div>
            </figcaption>
        ...
        <figure class="drinks b">
            ...
            <figcaption>
                <p>
                    Drinking ceylon tea acts as a backup to your immune system and gives it the extra jolt of minerals
                    and antioxidants it needs to help you recover faster.
                </p>
                <div class="price">
                    <s>LKR 360.00</s>LKR 280.00
                </div>
            </figcaption>
            <a href="#" class="add-to-cart"><i class="fa fa-heart" aria-hidden="true"></i></a>
        </figure>
        <figure class="drinks c">
            ...
            <figcaption>
                <p>
                    Its delicious water is a healthy and refreshing drink, with impressive medicinal, cosmetic, and
                    nutritional contributions.
                </p>
                <div class="price">
                    <s>LKR 300.00</s>LKR 170.00
                </div>
            </figcaption>
            <a href="#" class="add-to-cart"><i class="fa fa-heart" aria-hidden="true"></i></a>
        </figure>
