...
.text-name:hover {
    background-color: rgb(181, 200, 243);
}
...
.button {
    background-color: rgba(32, 37, 63, 0.667);
    padding: 5px 50px;
    line-height: 35px;
    display: flex;
    color: #f2f2f2;
        ...
        <div class="form-container">
            <form>
                ...
                <div class="input-name">
                    ...
                    <select name="countryCode" class="text-name-code">
                    ...
                    <span>
                        <input type="text" name="phone" class="text-name-phone">
                    </span>
                ...
                <div class="input-name">
                    ...
                    <input type="time" name="arrive-time" class="text-name">

                </div>
                <div class="input-name">
                    <label>Special Requirement</label><br>
                    <!--<input type="text-area" name="Requirement" placeholder="Enter.." class="text-name">-->
                    <textarea name="Requirements" class="text-name">Enter text here...</textarea>
                    ...
                    <div class="form-container">
                        <form>
                            ...
                            <div class="input-name">
                                ...
                                <input type="text" name="card-no" placeholder="xxxx xxxx xxxx xxxx" maxlength='16'
                                    class="text-name">
